...
gdjs.Loading_32Zero_32PhaseCode.userFunc0x34cba30 = function GDJSInlineCode(runtimeScene) {
"use strict";
(function() {
...
gdjs.Loading_32Zero_32PhaseCode.userFunc0x34cba30(runtimeScene);
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(44389228);
}
}
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("Satoshi_Loading"), gdjs.Loading_32Zero_32PhaseCode.GDSatoshi_9595LoadingObjects2);
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(44392916);
}
}
if (isConditionTrue_0) {
...
};gdjs.Loading_32Zero_32PhaseCode.asyncCallback44397724 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(2), (runtimeScene) => (gdjs.Loading_32Zero_32PhaseCode.asyncCallback44397724(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.Loading_32Zero_32PhaseCode.asyncCallback44400660 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.Loading_32Zero_32PhaseCode.localVariables);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(gdjs.Loading_32Zero_32PhaseCode.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.3), (runtimeScene) => (gdjs.Loading_32Zero_32PhaseCode.asyncCallback44400660(runtimeScene, asyncObjectsList)));
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(44398564);
}
}
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("LoadingText"), gdjs.Loading_32Zero_32PhaseCode.GDLoadingTextObjects1);
